...
- [ ] `[mcp]` SKIP: not an MCP server
- [x] `[complex]` HANDBOOK.md: comprehensive handbook at docs/handbook/ with 61 chapters + 4 appendices (2026-06-02)

## D. Shipping Hygiene

- [x] `[all]` `verify` script exists (test + build in one command) (2026-03-06)
- [x] `[all]` Version in manifest matches git tag — v3.1.0 (2026-07-23)

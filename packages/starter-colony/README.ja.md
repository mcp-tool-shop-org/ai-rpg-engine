...
**構成例**：このサンプルは、SFコロニーの生存のためにエンジンをどのように接続するかを示すものです。これは、参考として学ぶためのものであり、コピーするためのテンプレートではありません。独自のゲームを構築するには、[構成ガイド](../../docs/handbook/57-composition-guide.md)を参照してください。
...
| 機能 | コロニーが示すもの |
|---------|-------------------|
| **Engagement** | 隘路ゾーンのタグ、部隊ベースのバックライン/防御役 |
| **Resources** | コロニー全体で共有される電力資源と、環境による消費 |
| **Environment** | ゾーンの危険が資源の枯渇やシステム全体の故障を引き起こす |
| **Cognition** | 人間とは異なる認識を持つ異星生命体 |
...
環境要因による資源の圧迫と、部隊の役割。コロニーの電力資源が、戦闘だけでなく環境イベントによって枯渇し、システム全体の故障を引き起こす様子を研究してください。これにより、部隊全体で戦術的な資源配分が必要になります。

...
Esquemas de contenido y validadores para el motor de juegos de rol con IA. Permite definir habitaciones, entidades, diálogos, objetos y misiones como datos.
...
- **Esquemas de habitación:** Zonas con salidas, propiedades y estado ambiental.
- **Esquemas de entidad:** Definiciones de personajes no jugables (PNJs), criaturas y personajes del jugador.

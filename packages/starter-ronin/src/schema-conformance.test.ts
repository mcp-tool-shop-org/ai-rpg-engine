...
//
// This file closes the gap for jade-veil: the dialogue, the ability pack,
...
import { magistrateDialogue, roninAbilities, roninStatusDefinitions } from './content.js';

describe('schema-conformance: Jade Veil content validates against content-schema', () => {
  it('dialogue is structurally valid', () => {
    const result = validateDialogueDefinition(magistrateDialogue);

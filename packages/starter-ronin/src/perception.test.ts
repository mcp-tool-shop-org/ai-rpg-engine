...
// the pack's real 'perception' stat (the precision half of roninMinimalRuleset's
// combat/ability statMapping) would never influence AI perception. setup.ts
// must pass `{ perceptionStat: 'perception' }` explicitly.
...
describe('ronin setup — perception filter reads the real stat (F-bed426aa)', () => {

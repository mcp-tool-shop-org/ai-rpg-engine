...
export function createGame(seed?: number): Engine {
  ...
  const worldStack = buildWorldStack({
    ...
    // genre key ('gladiator-minimal' minus its '-minimal' suffix). 'gladiator'
    // has no GENRE_BUYABLE_STOCK/GENRE_RECIPES entry (today's fixed key set is
    ...
    tradeGenre: 'gladiator',
    craftingGenre: 'gladiator',
    economyGenre: 'gladiator',
  });

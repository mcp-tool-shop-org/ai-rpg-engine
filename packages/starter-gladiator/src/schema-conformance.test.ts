...
//
// This file closes the gap for iron-colosseum: the dialogue, the ability
...
import { patronDialogue, gladiatorAbilities, gladiatorStatusDefinitions } from './content.js';

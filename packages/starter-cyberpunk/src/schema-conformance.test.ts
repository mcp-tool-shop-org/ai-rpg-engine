...
//
// This file closes the gap for neon-lockbox: the dialogue, the ability pack,
...
import { fixerDialogue, cyberpunkAbilities, cyberpunkStatusDefinitions } from './content.js';

describe('schema-conformance: Neon Lockbox content validates against content-schema', () => {
  it('dialogue is structurally valid', () => {
    const result = validateDialogueDefinition(fixerDialogue);

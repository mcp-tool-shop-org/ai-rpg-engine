// Cyberpunk content integrity tests
//
...
describe('cyberpunk content — cross-reference integrity (F-4806a2c9)', () => {
  it('zones, dialogue speakers, and ids have no dangling references or duplicate ids', () => {
    ...
    const pack: ContentPack = {
      ...
      dialogues: [fixerDialogue],
      abilities: cyberpunkAbilities,
      statuses: cyberpunkStatusDefinitions,
    };
  ...
  it('every archetype.progressionTreeId resolves to a defined tree', () => {
    const treeIds = new Set([netrunningTree.id]);

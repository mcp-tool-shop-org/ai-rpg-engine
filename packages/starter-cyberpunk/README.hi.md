...
|---|---|
| **Rulesets** | `cyberpunkMinimalRuleset` — आँकड़े (क्रोम/रिफ्लेक्स/नेटरनिंग), संसाधन (एचपी/आइस/बैंडविड्थ), 8 क्रियाएं, जिनमें `hack` और `jack-in` शामिल हैं। |
...
| **Cognition & perception** | उच्च क्षरण + अस्थिरता, `reflex` पर आधारित धारणा, जिसमें `netrunning` संवेदी आँकड़ा शामिल है। |

...
AI RPG エンジンの開発者向けコマンドラインインターフェース。ターミナルから、シミュレーションの実行、検証、リプレイ、および詳細の確認が可能です。
...
- [CLI リファレンス (付録 D)](https://mcp-tool-shop-org.github.io/ai-rpg-engine/handbook/appendix-d-cli-reference/)
- [クイックスタート (第3章)](https://mcp-tool-shop-org.github.io/ai-rpg-engine/handbook/03-quick-start/)

...
Interfaz de línea de comandos (CLI) para el motor de juegos de rol con inteligencia artificial (AI RPG Engine): ejecute, valide, reproduzca e inspeccione sesiones de simulación desde su terminal.
...
- [Referencia de la CLI (Apéndice D)](https://mcp-tool-shop-org.github.io/ai-rpg-engine/handbook/appendix-d-cli-reference/)
- [Guía de inicio rápido (Cap. 3)](https://mcp-tool-shop-org.github.io/ai-rpg-engine/handbook/03-quick-start/)

...
//
// This file closes the gap for dust-devils-bargain: the dialogue, the
// ability pack, and the status pack now run through content-schema on every
// test run. (This pack defines no quests today — the quest check lives in
...
import { bartenderDialogue, weirdWestAbilities, weirdWestStatusDefinitions } from './content.js';

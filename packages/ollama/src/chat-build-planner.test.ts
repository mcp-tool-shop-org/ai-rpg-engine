...
describe('generateBuildPlan — artifact skipping', () => {
  it('skips district if session already has a matching one', () => {
    const session = makeSession({
      artifacts: { districts: ['market_district'], factions: [], quests: [], rooms: [], packs: [], entities: [], dialogues: [], abilities: [], statuses: [], items: [], hazards: [] },
    });
  ...
  it('skips factions if session already has matching ones', () => {
    const session = makeSession({
      artifacts: { districts: [], factions: ['market_guild'], quests: [], rooms: [], packs: [], entities: [], dialogues: [], abilities: [], statuses: [], items: [], hazards: [] },
    });
  ...
  it('does not skip when artifacts are unrelated', () => {
    const session = makeSession({
      artifacts: { districts: ['neon_alley'], factions: [], quests: [], rooms: [], packs: [], entities: [], dialogues: [], abilities: [], statuses: [], items: [], hazards: [] },
    });

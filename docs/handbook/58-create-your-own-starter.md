...
## Next: Give Each Archetype Its Own Rules

Once your starter boots, [Chapter 59 — Plug-in Profiles](./59-plugin-profiles.md) shows how to let different entities in the same world resolve combat through their own stat mappings — a `might` fighter and a `will` mystic in one fight.

...
- Substituições de fórmulas serializáveis — ajuste de fórmulas por perfil (pendente de uma DSL de fórmulas; os perfis contêm mapeamentos de estatísticas hoje, e não funções de fechamento)

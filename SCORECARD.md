...
**Date:** 2026-07-26 (v3.5.0 — item-chronicle activation + Salt Road Ledger; `shipcheck audit` 23 checked / 0 unchecked / 16 skipped, 100% pass, all hard gates green. Prior snapshots: v2.6.0 dogfood swarm 2026-07-18; original audit 2026-03-06 at v1.0.0). The v2.5 swarm also made the quality gates real: pack rubric on the live catalog, docs-integrity vs the latest tag, coverage ratchet, and a LICENSE packaging gate that blocks publish (each with a mutation meta-test).
...
| C. Operator Docs | 10/10 | README, CHANGELOG, LICENSE, handbook (64 chapters + 4 appendices) |
| D. Shipping Hygiene | 10/10 | verify script, v3.5.0, dep scanning, clean packaging |

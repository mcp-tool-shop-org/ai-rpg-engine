...
| [`@ai-rpg-engine/starter-bounty-hunter`](packages/starter-bounty-hunter) | Début d’une mission de traque : poursuite dans un circuit fermé, et quelle moitié de la ville vous ouvrira ses portes. |
...
| [`starter-bounty-hunter`](packages/starter-bounty-hunter) | Poursuite | Chasse à l’homme pour de l’argent ; la violence est manifeste, mais pas interdite. |
